...
oneBTN = InlineKeyboardButton(text=f'{dtimee.transweek(week_three)}', callback_data='right_weather')
threeBTN = InlineKeyboardButton(text=f'{dtimee.transweek(week_thour)}', callback_data='left_weather')
thourBTN = InlineKeyboardButton(text=f'{dtimee.transweek(week_five)}', callback_data='thourbtn')
fiveBTN = InlineKeyboardButton(text=f'{dtimee.transweek(week_six)}', callback_data='fivebtn')
sixBTN = InlineKeyboardButton(text=f'{dtimee.transweek(week_two)}', callback_data='sixbtn')
